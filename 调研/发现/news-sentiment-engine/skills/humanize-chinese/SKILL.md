...
description: Detect and rewrite AI-like Chinese text with a practical workflow for scoring, humanization, academic AIGC reduction, and style conversion. Use when the user asks to 去AI味, 降AIGC, 去除AI痕迹,
category: Business & Marketing
source: antigravity
tags: [python, ai, workflow, template, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/humanize-chinese
---
