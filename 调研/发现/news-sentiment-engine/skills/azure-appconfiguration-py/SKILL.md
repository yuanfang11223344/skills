...
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/azure-appconfiguration-py
---
...
3. **Make production settings read-only** to prevent accidental chang
