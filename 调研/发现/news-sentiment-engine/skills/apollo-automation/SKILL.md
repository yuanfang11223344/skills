...
url: https://github.com/ComposioHQ/awesome-claude-skills/tree/master/apollo-automation
---
...
- **People search returns obfuscated data**: `APOLLO_PEOPLE_SEARCH` may show `has_email`/`
