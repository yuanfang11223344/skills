...
category: AI & Agents
source: antigravity
tags: [react, nextjs, api, mcp, claude, ai, agent, gpt, workflow, template]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/appdeploy
---
...
Use this when you want to permanently delete an app. Use o
