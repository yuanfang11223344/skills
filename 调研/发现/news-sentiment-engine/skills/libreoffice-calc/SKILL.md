...
source: antigravity
tags: [python, pdf, xlsx, api, ai, automation, workflow, template, document, spreadsheet]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/libreoffice/calc
---
