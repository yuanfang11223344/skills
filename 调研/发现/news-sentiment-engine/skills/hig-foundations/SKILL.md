...
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/hig-foundations
---
...
5. **Privacy + Writing + Onboarding** -- Permission requests need clear, specific u
