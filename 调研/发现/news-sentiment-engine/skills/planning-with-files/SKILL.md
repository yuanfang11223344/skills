...
category: AI & Agents
source: antigravity
tags: [pdf, markdown, api, claude, ai, automation, template, image, rag]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/planning-with-files
---
