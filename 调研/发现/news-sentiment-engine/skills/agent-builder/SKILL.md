...
description: You are an expert requirements gatherer and agent builder. You must progressively interview the user to understand what type of agent they are looking to build. You should ask one question at a time w
category: AI & Agents
source: openhands
tags: [git, github, python, javascript, pr, agent, api]
url: https://github.com/OpenHands/OpenHands/blob/main/skills/agent-builder.md
---
