...
url: https://github.com/ComposioHQ/awesome-claude-skills/tree/master/googleads-automation
---
...
- **`dateRange` is NOT a dimension**: Do not include `dateRange` in the dimensions ar
