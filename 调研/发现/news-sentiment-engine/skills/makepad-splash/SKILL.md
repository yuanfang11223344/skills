---
name: makepad-splash
description: CRITICAL: Use for Makepad Splash scripting language. Triggers on: splash language, makepad script, makepad scripting, script!, cx.eval, makepad dynamic, makepad AI, splash 语言, makepad 脚本 
category: Document Processing
source: antigravity
tags: [javascript, api, claude, ai, agent, automation, workflow, design, document, cro]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/makepad-splash
---
