...
source: composio
tags: [api, cli, mcp, automation, ai, claude]
url: https://github.com/ComposioHQ/awesome-claude-skills/tree/master/toggl-automation
---
...
|---|---|
| `TOGGL_CREATE_TIME_ENTRY` | Create a time entry or running timer (requires `workspace_id`, `created_wit
