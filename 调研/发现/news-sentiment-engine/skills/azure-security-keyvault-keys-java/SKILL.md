...
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/azure-security-keyvault-keys-java
---
...
// Wait for deletion
DeletedKey deletedKey = deletePoller.poll().getV
