---
name: pdflatex
description: PdfLatex is a tool that converts Latex sources into PDF. This is specifically very important for researchers, as they use it to publish their findings. It could be installed very easily using Linux te
category: Development & Code Tools
source: openhands
tags: [linux, pr, agent, tool]
url: https://github.com/OpenHands/OpenHands/blob/main/skills/pdflatex.md
---
