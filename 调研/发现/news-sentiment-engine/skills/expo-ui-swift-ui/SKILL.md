...
description: name: expo-ui-swift-ui npx expo install @expo/ui A native rebuild is required after installation (`npx expo run:ios`). 
category: Creative & Media
source: antigravity
tags: [react, api]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/expo-ui-swift-ui
---
