...
source: antigravity
tags: [javascript, api, claude, ai, template, design, security, vulnerability, seo]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/indexing-issue-auditor
---
...
- **Problem**: Ignoring "Crawl Depth" (pages bu
