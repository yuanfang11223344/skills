...
source: antigravity
tags: [markdown, api, mcp, claude, ai, agent, llm, document, spreadsheet, security]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/bdistill-knowledge-extraction
---
