...
category: AI & Agents
source: antigravity
tags: [node, api, claude, ai, workflow, security]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/iterate-pr
---
...
Do NOT assume what failed based on check name alone—always read the logs. Do NOT "quick fix and hope" — und
