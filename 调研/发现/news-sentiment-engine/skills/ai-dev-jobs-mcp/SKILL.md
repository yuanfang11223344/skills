...
source: antigravity
tags: [python, api, mcp, claude, ai, agent, llm, workflow, design, cro]
url: https://github.com/sickn33/antigravity-awesome-skills/tree/main/skills/ai-dev-jobs-mcp
---
...
- Salary data is available when companies provide it
