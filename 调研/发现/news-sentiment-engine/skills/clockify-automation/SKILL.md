...
source: composio
tags: [api, mcp, automation, ai, claude]
url: https://github.com/ComposioHQ/awesome-claude-skills/tree/master/clockify-automation
---
...
| `CLOCKIFY_GET_ALL_MY_WORKSPACES` | List all workspaces for the authentica
