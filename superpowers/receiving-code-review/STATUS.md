# receiving-code-review 情况说明

状态：Active

## 基本信息

- 路径：`/Users/ganxuanzhi/skills/superpowers/receiving-code-review`
- 入口：`SKILL.md`
- 分类：`superpowers`
...
- especially if feedback seems unclear or technically questionable - requires tech
