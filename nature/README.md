...
11 个 AI skill，覆盖从文献检索、论文精读、学术写作/润色、图表制作、引文管理，到审稿回复、PPT 汇报、专利申请的完整学术工作流。

> 同目录下另见 [paper-craft/](../paper-craft/README.md) — 论文可视化与呈现（深度HTML解读、方法图解、AIGC幻灯片），与 nature 互补。
