# academic-paper-reviewer 情况说明

状态：Active

## 基本信息

- 路径：`/Users/ganxuanzhi/skills/academic-research/academic-paper-reviewer`
- 入口：`SKILL.md`
...
- 首选场景：见 academic-research/README.md
- 与 nature 分类有功能重叠，需根据场景推荐（见分类 README.md 对比表）
